  ...
  render() {
    return (
      <Row>
        ...
        { this.state.showDialog && <PropertyDialog 
                                      // setDialogType={(dialogType: PropertyDialogTypes) => this.setState({propDialogType: dialogType})} 
                                      toggleToClose={() => this.setState({showDialog: false})}
                                      dialogType={this.state.propDialogType} />}
      </Row>
    )
  }
}